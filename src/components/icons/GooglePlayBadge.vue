<template>
	<svg viewBox="0 0 260 80" fill="none" xmlns="http://www.w3.org/2000/svg">
		<g clip-path="url(#a)">
			<mask id="b" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#b)">
				<path
					d="M260 80H10A10 10 0 0 1 0 70V10A10 10 0 0 1 10 0h250a10 10 0 0 1 10 10v60a10 10 0 0 1-10 10Z"
					fill="#000"
				/>
			</g>
			<mask id="c" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#c)">
				<path
			...
			<mask id="d" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#d)">
				<path
			...
			<mask id="e" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#e)">
				<path
			...
			<mask id="f" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#f)">
				<path
			...
			<mask id="g" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#g)">
				<path
			...
			<mask id="h" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#h)">
				<path
			...
			<mask id="i" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#i)">
				<path
			...
			<mask id="j" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#j)">
				<path
			...
			<mask id="k" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#k)">
				<path
			...
			<mask id="l" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#l)">
				<path
			...
			<mask id="m" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#m)">
				<path
			...
			<mask id="n" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#n)">
				<path d="M20.1 18.6 20 20v40l.2 1.4 22-22-22-20.8Z" fill="#4285F4" />
			</g>
			<mask id="o" style="mask-type: luminance" maskUnits="userSpaceOnUse">
				<path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
			</mask>
			<g mask="url(#o)">
				<path
